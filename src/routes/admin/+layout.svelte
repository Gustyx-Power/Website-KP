...
>
	...
	>
		...
		<div class="flex-1 overflow-y-auto px-4 py-6 space-y-1">
			...
			<!-- Divider -->
			<div class="my-2 border-t border-[#e4e9ed]"></div>

			<!-- Utilitas Section -->
			<div class="px-4 py-2">
				<p class="text-xs uppercase tracking-wider text-[#acb3b7] font-semibold">Utilitas</p>
			</div>
...
<style>
	/* Small custom utility just for layout fade in */
	@keyframes fadeIn {
		from {
			opacity: 0;
